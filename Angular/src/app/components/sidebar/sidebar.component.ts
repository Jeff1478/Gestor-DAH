...
export class SidebarComponent implements OnInit {
  ...
  goSearchP(provincia_id: any) {
    ...
    this.searchSitio = this.prov
    console.log(this.searchSitio)

    this._router.navigate(['/pag-lite-sitios', this.searchSitio]);

   
  }

  goSearchC(canton_id : any) {
